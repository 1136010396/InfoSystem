...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, root):
        ...
        label = tk.Label(self, text="学生信息管理系统")
        label.pack(pady=100)
...
class PageOne(tk.Frame):
    def __init__(self, parent, root):
        ...
        label = tk.Label(self, text="添加学生信息")
        label.pack(pady=100)
        ...
        Label(self,text='学生成绩：',font=ft3).pack(side=TOP)
        global e3
        e3=StringVar()
...
class PageTwo(tk.Frame):
    def __init__(self, parent, root):
        ...
        label = tk.Label(self, text="删除学生信息")
        label.pack(pady=100)
...
class PageThree(tk.Frame):
    def __init__(self, parent, root):
        ...
        tk.Label(self, text="修改学生信息").pack(pady=100)
...
class PageFour(tk.Frame):
    def __init__(self, parent, root):
        super().__init__(parent)
        # label = tk.Label(self, text="查询学生成绩", font=LARGE_FONT)
        label = tk.Label(self, text="查询学生成绩")
        label.pack(pady=100)
